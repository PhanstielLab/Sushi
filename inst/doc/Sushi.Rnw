...
con="~/Dropbox/Sushi/Rpackage/Sushi/inst/doc/Sushi.bib")
@
...
plotManhattan(bedfile=Sushi_GWAS.bed,pvalues=Sushi_GWAS.bed[,5],col=SushiColors(6),
...
\begin{center}
<< fig = FALSE , echo = TRUE, height=6,width=8>>=
  print ("working on it")
@
\end{center}
...
labelgenome(chrom="chr11",chromstart=1650000,chromend=2350000,side=1,n=4,scale="Mb",line=.25)
labelgenome(chrom="chr11",chromstart=1650000,chromend=2350000,side=1,n=3,scale="Kb",line=2)
labelgenome(chrom="chr11",chromstart=1650000,chromend=2350000,side=1,n=1,scale="bp",line=4)
@
...
<<fig = TRUE , echo = TRUE,height=6,width=9>>=
plotManhattan(bedfile=Sushi_GWAS.bed,pvalues=Sushi_GWAS.bed[,5],col=SushiColors(6),
                genome=Sushi_hg18_genome,cex=0.75,space=0.05)
labelgenome(genome=Sushi_hg18_genome,n=4,scale="Mb",edgeblankfraction=0.20,cex.axis=.5,space=0.05)
axis(side=2,las=2,tcl=.2)
mtext("log10(P)",side=2,line=1.75,cex=1,font=2)
mtext("chromosome",side=1,line=1.75,cex=1,font=2)
@
