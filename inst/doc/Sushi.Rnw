...
\begin{tabular}{l|r}
\texttt{Sushi\_5C.bedpe} & \\
\texttt{Sushi\_ChIAPET\_pol2.bedpe} & \\
\texttt{Sushi\_ChIPExo\_CTCF.bedgraph} & \\
\texttt{Sushi\_ChIPSeq\_CTCF.bedgraph} & \\
\texttt{Sushi\_ChIPSeq\_pol2.bed} & \cite{encode_integrated_2012} \\
\texttt{Sushi\_ChIPSeq\_pol2.bedgraph} & \\
\texttt{Sushi\_ChIPSeq\_severalfactors.bed} & \\
\texttt{Sushi\_DNaseI.bedgraph} & \\
\texttt{Sushi\_GWAS.bed} & \\
\texttt{Sushi\_HiC.matrix} & \\
\texttt{Sushi\_RNASeq\_K562.bedgraph} & \\
\texttt{Sushi\_genes.bed} & \\
\texttt{Sushi\_hg18\_genome} & \\
\texttt{Sushi\_transcripts.bed} & \\
\end{tabular}
