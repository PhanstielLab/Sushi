...
finalcolor1 = rgb(col2rgb("blue")[1], col2rgb("blue")[2], 
                  col2rgb("blue")[3], alpha=.5 * 255, max = 255)
finalcolor2 = rgb(col2rgb("#E5001B")[1], col2rgb("#E5001B")[2],
                  col2rgb("#E5001B")[3], alpha=.5 * 255, max = 255)

legend("topright",inset=0.025, legend=c("DNaseI","ChIP-seq (CTCF)"),
       fill=c(finalcolor1,finalcolor2), border=c("blue","#E5001B"),
       text.font=2, cex=1.0)
